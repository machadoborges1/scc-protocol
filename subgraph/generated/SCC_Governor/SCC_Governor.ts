...
export class SCC_Governor__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class SCC_Governor__proposalVotesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SCC_Governor extends ethereum.SmartContract {
  static bind(address: Address): SCC_Governor {
    return new SCC_Governor("SCC_Governor", address);
  }
  ...
  INITIAL_PROPOSAL_THRESHOLD(): BigInt {
    let result = super.call(
  ...
  try_INITIAL_PROPOSAL_THRESHOLD(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "INITIAL_PROPOSAL_THRESHOLD",
      "INITIAL_PROPOSAL_THRESHOLD():(uint256)",
      [],
  ...
  INITIAL_QUORUM_PERCENT(): BigInt {
    let result = super.call(
      "INITIAL_QUORUM_PERCENT",
      "INITIAL_QUORUM_PERCENT():(uint256)",
      [],
    );
  ...
  try_INITIAL_QUORUM_PERCENT(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "INITIAL_QUORUM_PERCENT",
      "INITIAL_QUORUM_PERCENT():(uint256)",
      [],
  ...
  try_INITIAL_VOTING_DELAY(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "INITIAL_VOTING_DELAY",
      "INITIAL_VOTING_DELAY():(uint256)",
      [],
  ...
  try_INITIAL_VOTING_PERIOD(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "INITIAL_VOTING_PERIOD",
      "INITIAL_VOTING_PERIOD():(uint256)",
      [],
  ...
  eip712Domain(): SCC_Governor__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new SCC_Governor__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<SCC_Governor__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new SCC_Governor__eip712DomainResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toString(),
        value[3].toBigInt(),
  ...
  proposalVotes(proposalId: BigInt): SCC_Governor__proposalVotesResult {
    let result = super.call(
      "proposalVotes",
    ...
    return new SCC_Governor__proposalVotesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_proposalVotes(
    proposalId: BigInt,
  ): ethereum.CallResult<SCC_Governor__proposalVotesResult> {
    let result = super.tryCall(
      "proposalVotes",
      "proposalVotes(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SCC_Governor__proposalVotesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
